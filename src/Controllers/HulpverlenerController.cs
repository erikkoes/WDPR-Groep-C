...
namespace src
{
    public class HulpverlenerController : Controller
    {
        ...
        public HulpverlenerController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,naam,achternaam,specialiteit,beschrijving,imagePath")] Hulpverlener hulpverlener)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,naam,achternaam,specialiteit,beschrijving,imagePath")] Hulpverlener hulpverlener)
        {
